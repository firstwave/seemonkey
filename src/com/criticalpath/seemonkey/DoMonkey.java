...
public class DoMonkey implements IRobot {
	   ...
	   protected void key(boolean down, int keycode){
	      ...
	      press(code, down?IChimpDevice.DOWN : IChimpDevice.UP);
	      */
	   }
	   ...
	   public void keyPress(int keycode){
	      Debug.log(5, "MonkeyRobot.keypress");
	      // TODO: keycode to string
	      //_dev.press(keycode, IChimpDevice.DOWN);
	      delay(_autoDelay);
	   }

	   public void keyRelease(int keycode){
	      Debug.log(5, "MonkeyRobot.keyRelease");
	      // TODO: keycode to string
	      //_dev.press(keycode, IChimpDevice.UP);
	      delay(_autoDelay);
	   }  
	   ...
	   public void mousePress(int buttons){
	      Debug.log(5, "MonkeyRobot.mousePress");
	      _device.touch(_mouse.x, _mouse.y, TouchPressType.DOWN);
	      delay(_autoDelay);
	   }
	   public void mouseRelease(int buttons){
	      Debug.log(5, "MonkeyRobot.mouseRelease");
